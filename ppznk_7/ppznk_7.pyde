...
class Owl(Pet):
    def __init__(self, name):
        self.name = name 
    def speak(self):
        text('huhu', random(50, width-70), random(50, height-50))
        return 'huhu'
    def __sub__(self, other):
        return self.name*2 + other.name[::2]*3
...
def setup():
    ...
    global list_of_pets
    list_of_pets = [rex, benio, skrypcik, sowka] # lista zawiera różne typy zwierząt
